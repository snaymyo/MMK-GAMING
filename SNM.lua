...
"🌟 WALL HACK G90T",
"🌟 COLOR RED ",
"🔙EXIT"}, nil, "CODES BY DIVINE \n JOIN TELEGRAM - @DivineGamingXD ")
if DIE1 == nil then else
if DIE1[1] == true then WH() end
if DIE1[2] == true then CH() end
if DIE1[3] == true then EXIT() end
end
DIE = -1
end
...
gg.clearResults()
  ...
  gg.clearResults()
  gg.alert("🔱Wallhack Mediatek G90t Activated🔱")
end
...
function SNMW()
  ...
  }, nil, "🧱 Other WallHack Menu 🧱\n✍️ Creditor by - D Kit Nay ✍️")
...
gg.toast("🧱 WallHack Snapdragon Actived...✔️")
...
gg.toast("🧱 WallHack Item Actived...✔️")
...
gg.searchNumber("3.5873241e-43;1.1210388e-44;0.5", 16, false, 536870912, 0, -1)
